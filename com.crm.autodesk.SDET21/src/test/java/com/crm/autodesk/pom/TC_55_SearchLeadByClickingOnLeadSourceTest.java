...
public class TC_55_SearchLeadByClickingOnLeadSourceTest extends BaseClass{
	...
	public void SearchLeadByClickingOnLeadNo() throws Throwable
	{
		...
		String LeadSource = eLib.getExcellData("Sheet1", 1, 5);
	   //navigate to lead page
		...
		wLib.select(driver, lpar, "Lead Source" );
		lp1.clickonLeadSource();
		...
		leadp.clickonLeadSourseEdt(LeadSource);
